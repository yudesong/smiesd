...
<div style="margin-left:20px;margin-top:0px;width:1200px;height:500px;">	
	...
	<div class="control-group">
		<label class="control-label">原分类名：</label>
		<div class="controls">
				
			<select id="ch_fenlei_oname" name="ch_fenlei_oname">
				<?php
			...
			<!--
			<input type="text" class="input-xlarge" style="width:200px;" name="ch_fenlei_oname" id="ch_fenlei_oname"/>
			-->
		</div>
	</div>

	<div class="control-group">
		<label class="control-label">新分类名：</label>
		<div class="controls">
			<input type="text" class="input-xlarge" style="width:200px;" name="ch_fenlei_nname" id="ch_fenlei_nname"/>
		</div>
	</div>	

	<div class="alert alert-success" style="display:none" id="ch_fenlei_success">修改分类成功！</div>
	<div class="alert alert-error" style="display:none" id="ch_fenlei_error">修改分类失败！</div>
	<div class="form-actions">
		<button type="button" class="btn btn-primary" id="ch_fenlei_btn">修改</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
