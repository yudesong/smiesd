...
<div style="margin-left:20px;margin-top:0px;width:1200px;height:500px;">	
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" class="input-xlarge" style="width:200px;" name="name" id="name"/>
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="password" class="input-xlarge" style="width:200px;" name="passwd" id="passwd"/>
		</div>
	</div>
	<div class="alert alert-success" style="display:none" id="show_success">修改成功。</div>
	<div class="alert alert-warning" style="display:none" id="show_error">修改失败。</div>	
	<div class="form-actions">
		<button type="button" class="btn btn-primary" id="btn_ch">确定</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<button type="button" class="btn btn-primary" id="btn_unch">取消</button>
	</div>
	</form>
	</div>
	</div>
