...
<div style="margin-left:20px;margin-top:0px;width:1200px;height:500px;">	
	...
	<div id="content">
		<div class="container-fluid">
	<form method="post" class="form-horizontal" id="upload_kejian" enctype="multipart/form-data" action="upload.php">
	<legend>添加课件</legend>

	<div class="control-group">
		<label class="control-label">选择标签：</label>
		<div class="controls">
			<select id="add_kejian_biaoqian" name="add_kejian_biaoqian">
				<?php
	...
	<div class="control-group">
		...
		<div class="controls">
            <input type="text"  class="form-control" id="kejian_content" name="kejian_content" style="width:400px;"/>
		</div>
	</div>
        
	<div class="alert alert-success" style="display:none" id="add_kejian_success">添加课件成功。</div>
	<div class="alert alert-warning" style="display:none" id="add_kejian_error">添加课件失败。</div>	
	
	<div class="form-actions">
		<button type="button" class="btn btn-primary" id="add_kejian_btn">上传</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
