...
<div style="margin-left:20px;margin-top:0px;width:1200px;height:500px;">	
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" class="input-xlarge" style="width:500px;" name="add_note" id="add_note"/>
		</div>
	</div>
	<div class="alert alert-success" style="display:none" id="add_note_success">添加通知成功！</div>	
	<div class="alert alert-error" style="display:none" id="add_note_success">添加通知失败！</div>
	<div class="form-actions">
		<button type="button" class="btn btn-primary" id="add_note_btn">添加</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
