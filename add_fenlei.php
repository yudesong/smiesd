...
<div style="margin-left:20px;margin-top:0px;width:1200px;height:500px;">	
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" class="input-xlarge" style="width:200px;" name="add_fenlei_name" id="add_fenlei_name"/>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<span class="alert alert-warning" style="display:none" id="add_fenlei_error">该分类已存在！</span>
		</div>
	</div>
	<div class="alert alert-warning" style="display:none" id="add_fenlei_success">添加分类成功！</div>
	<div class="form-actions">
		<button type="button" class="btn btn-primary" id="add_fenlei_btn">添加</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
