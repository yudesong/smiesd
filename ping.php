...
<table class="table table-hover table-striped">
				...
				<tbody>
					<?php
						...
						$ConDB=new BeanConn;
						$ConDB->getConn();	
						$sql="select name,content,date from tb_ping";
						...
						while($row = @mysql_fetch_array($resultset)){
							...
							if($var==2) echo "success'";
							if($var==3) echo "info'";	
							if($var==4) echo "warning'";
							if($var==5) echo "success'";
							echo "><td>";
							echo $var;
							echo "</td>";
							echo "<td>";
							...
							echo "</td>";							
							echo "<td>";
							echo "<a href='conn/conn.php?type=ping&id=$var'>回复</a>";
							echo "</td>";
							echo "</tr>";
							$var++;
						}
